...
translations = {
    "ar": {
        ...
        "app_description_question": "الرجاء إدخال وصف التطبيق.",
        ...
        "manual_translation_prompt": "الرجاء إدخال الترجمة باللغة الإنجليزية للوصف.",
        "auto_translation_used": "سيتم استخدام الترجمة التلقائية.",
        "mod_features_question": "الرجاء إدخال ميزات التعديل.",
